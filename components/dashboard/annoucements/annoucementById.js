...
export default function AnnoucementById({ announcement, announcementId }) {
  ...
  return (
    <>
            ...
            <div>
              ...
              <div className="mt-2 flex flex-col items-center gap-2 text-xs text-slate-500 dark:text-slate-400 sm:flex-row sm:items-center sm:gap-3">
                <span className="inline-flex items-center gap-1">
                  <User className="h-3 w-3" /> {announcement.author}
                </span>
                <span className="inline-flex items-center gap-1">
            ...
            <div className="mt-3 flex w-full justify-center gap-2 sm:mt-0 sm:w-auto sm:justify-end">
              <a
                href={`mailto:?subject=${encodeURIComponent(
                  announcement.title
                )}&body=${encodeURIComponent(announcement.content)}`}
      ...
      {/* Comments placed in their own card/container */}
